...
print -dpng -r72 testfigure.png %HOW TO SAVE FIGURE!!!! -r72 how to change resolution of your figure 
...
print -dpng -r300 testfigure2.png %-r300 boosts the resolution  to 300pdi
...
set(gcf,'PaperPosition',[1 1 4 3]) %gcf- get current figure and then settin the paper postions of the graph (relative to an 8 by 11 inch paper). [doesnt matter, doesn't matter, width, height)
